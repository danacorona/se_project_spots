...
const newPostSubmitBtn = document.querySelector("#new-post-submit-btn");
...
function checkTargetContents(modalType, evt) {
  const modalContainer = modalType.querySelector(".modal__container");
